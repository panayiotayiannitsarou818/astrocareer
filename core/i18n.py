...
TR = {
    "el": {
        ...
        "auto_error_auth": "Το OpenAI API key δεν έγινε δεκτό (μη έγκυρο ή ληγμένο). Έλεγξε ότι το αντέγραψες σωστά, χωρίς κενά, και ότι είναι ακόμη ενεργό.",
        "auto_error_rate_limit": "Το OpenAI API απάντησε ότι ξεπεράστηκε το όριο αιτημάτων ή το διαθέσιμο υπόλοιπο του λογαριασμού. Δοκίμασε ξανά σε λίγο, ή έλεγξε το πλάνο χρέωσης/το υπόλοιπο του λογαριασμού σου.",
        "auto_error_timeout": "Το αίτημα προς το OpenAI API καθυστέρησε πολύ και ακυρώθηκε (timeout). Δοκίμασε ξανά -- συνήθως είναι προσωρινό.",
        "auto_error_connection": "Δεν ήταν δυνατή η σύνδεση με το OpenAI API. Έλεγξε τη σύνδεσή σου στο internet και δοκίμασε ξανά.",
        "auto_error_server": "Το OpenAI API αντιμετώπισε δικό του πρόβλημα (σφάλμα διακομιστή). Δεν φταίει κάτι στην ανάλυση σου -- δοκίμασε ξανά σε λίγο.",
    ...
    "en": {
        ...
        "auto_error_auth": "The OpenAI API key was rejected (invalid or expired). Check that you copied it correctly, with no extra spaces, and that it's still active.",
        "auto_error_rate_limit": "The OpenAI API reported that the request rate limit or account balance was exceeded. Try again shortly, or check your billing plan/account balance.",
        "auto_error_timeout": "The request to the OpenAI API took too long and timed out. Try again -- this is usually temporary.",
        "auto_error_connection": "Could not connect to the OpenAI API. Check your internet connection and try again.",
        "auto_error_server": "The OpenAI API had a problem on its own side (server error). Nothing about your analysis is at fault -- try again shortly.",
